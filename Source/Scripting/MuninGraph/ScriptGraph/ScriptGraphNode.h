...
class ScriptGraphNode : public NodeGraphNode<ScriptGraphPin, ScriptGraphBase, ScriptGraphSchema>
{
...
public:
	...
	virtual FORCEINLINE ScriptGraphNodeType GetNodeType() const { return ScriptGraphNodeType::Standard; }
	virtual FORCEINLINE std::string_view GetCompactTitle() const { return GetNodeTitle(); }
