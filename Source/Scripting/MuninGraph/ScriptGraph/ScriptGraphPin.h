...
public:
	...
	FORCEINLINE void SetLabelVisible(bool aIsVisible) { myLabelVisible = aIsVisible;}
	...
	bool TrySetValue(const TypedDataContainer& aValueContainer);

	bool TryGetValue(TypedDataContainer& aValueContainer) const;
