...
// Declares a group of Types that will be declared in this Header file.
#define DECLARE_TYPEGROUP(N) __pragma(comment(linker, "/include:__MG_TypeGroup_"#N))

// Defines a group of Types that will be defined in this CPP.
#define DEFINE_TYPEGROUP(N) extern "C" void __MG_TypeGroup_##N(){};
