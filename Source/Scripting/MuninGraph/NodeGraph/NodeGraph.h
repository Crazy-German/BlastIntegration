...
template <typename NodeClass, typename NodePinClass, typename NodeEdgeClass, typename NodeGraphSchemaClass>
bool NodeGraphInternal<NodeClass, NodePinClass, NodeEdgeClass, NodeGraphSchemaClass>::Serialize([[maybe_unused]] std::vector<uint8_t>& outResult)
{
	throw std::runtime_error("This myGraph has not implemented Serialize!");
}

template <typename NodeClass, typename NodePinClass, typename NodeEdgeClass, typename NodeGraphSchemaClass>
bool NodeGraphInternal<NodeClass, NodePinClass, NodeEdgeClass, NodeGraphSchemaClass>::Deserialize([[maybe_unused]] const std::vector<uint8_t>& inData)
{
