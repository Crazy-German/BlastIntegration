...
protected:
	...
	virtual bool RegisterNode(const std::shared_ptr<NodeClass>& aNode)
	{
...
public:
	...
	[[nodiscard]] const std::map<size_t, NodePinClass*>& GetPins() const
	{
	 ...
	 */
	virtual int CreateEdge(size_t aSourcePinUID, size_t aTargetPinUID) = 0;
